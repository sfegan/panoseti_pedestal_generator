...
# pcap_capture_pedestal_events.py: Captures pedestal events from PANOSETI quabo boards by 
#                                  sending software trigger commands at a specified frequency 
#                                  and recording their responses in Pcapng format.

# THIS VERION IS DEPRECATED AND UNMAINTAINED. Active development has moved to the more general 
# capture_pedestal_events.py which supports PFF and PCAPNG formats.
